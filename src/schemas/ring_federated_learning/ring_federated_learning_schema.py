...
from src.constants.topology_constants import TOPOLOGY_RING
...
class RingFederatedLearningSchema(FederatedBase):
    ...
    def __init__(
        ...
        """Creates a new TraditionalFederatedLearningSchema object.

        Args:
            server_template (Type[FederatedNode]): The template for the server node.
