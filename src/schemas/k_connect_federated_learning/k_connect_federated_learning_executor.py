...
from src.schemas.k_connect_federated_learning.k_connect_federated_learning import \
    KConnectFederatedLearning
from src.schemas.k_connect_federated_learning.k_connect_federated_learning_schema import KConnectFederatedLearningSchema
