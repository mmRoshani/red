...
@remote(num_cpus=TOPOLOGY_MANAGER_CPU_RESOURCES)
class TopologyManager:
    ...
    def get_neighbors(self, node_id: str):
        ...
        `neighbors` property of a FederatedNode.
    ...
    def build_network(self, node_ids: List[str], topology: Union[str, np.ndarray]):
        ...
        if isinstance(self._topology, str):
            ...
            raise NotImplementedError  # TODO: implement the matrix neighborhood selection
